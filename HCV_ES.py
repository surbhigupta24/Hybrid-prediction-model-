# -*- coding: utf-8 -*-
"""
Created on Tue May 26 17:49:31 2020
...
########### 'SMOTE bordeline 1'
bsmote1 =  BorderlineSMOTE()
bs1x, bs1y = bsmote1.fit_sample(X, y)
Ensemble_and_Stacking(bs1x, bs1y)

########### 'SMOTE bordeline 2'
bsmote2 =  BorderlineSMOTE(kind='borderline-2')
